...
@section('breadcrumb')
    <x-breadcrumb pageone="Service" pageoneRoute="{{ route('service.index') }}" pagetwo="Edit" />
@endsection
@section('content')
                    ...
                    <form action="{{ route('service.update',$service->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-12 gap-5 ">
                            <div class="col-span-12 lg:col-span-8 bg-white dark:bg-gray-800 p-4 rounded-lg">
                                ...
                                <div class="py-2">
                                    <x-form.textarea label="Short Description" name="short_description" value="{{ $service->short_description }}" />
                                ...
                                <textarea name="description" class="ckeditor" id="myeditorinstance" cols="30" rows="10">{{$service->description}}</textarea>
                                @error('description')
                                    <p class="text-sm text-red-600 mt-2">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-span-12 lg:col-span-4 bg-white dark:bg-gray-800 p-4 rounded-lg">
                                ...
                                <div class="py-1">
                                    ...
                                    <input type="number" id="price" name="price" value={{$service->price}} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="price"  />
                                </div>
